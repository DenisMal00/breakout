...
public class GamePanel extends JPanel {
    ...
    public GamePanel(GameController controller,ResourceManager resourceManager) {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            @Override
            public void mouseMoved(MouseEvent e) {controller.movePaddleTo(e.getX());}
        });
    }
    @Override
        ...
        for (Brick brick : bricks.getBricks()) {
            if (brick.isVisible()) {
                BufferedImage brickImage = switch (brick.getHitPoints()) {
                    case -1 -> images.getImage("brick_-1");
    ...
    private void drawPaddle(Graphics2D g2d) {
        ...
        int shadowOffset = 1;
        Color shadowColor = new Color(0, 0, 0, 255);
    ...
    private void gameInfo(Graphics2D g2d) {
        ...
        g2d.drawString("Vite: " + controller.getLives(), 10,getHeight()-10);
